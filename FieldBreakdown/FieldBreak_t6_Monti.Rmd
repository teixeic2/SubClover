...
---
Purpose : 
This script reads the data from the field seed hardness breakdown generated in script 2  (buried mesh bags for Monti )
...
Select the rows of interest here . Call for cultivar Monti 
