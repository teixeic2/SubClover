...
-Combine the rate of first trifoliate appearance with Mean Air Temp during trifo appearance   
...
Bring data from emergence folder 
...
```{r}
  ...
  write.table(dfok,"df_DASFirstTrifo_MeanAirT.txt")
