...
OverallAverage %>%
  ...
  scale_x_continuous(limits = c(0,0.03),breaks=c(0,0.005, 0.01,0.015, 0.02,0.025, 0.03))+
...
#remove grid lines 
  ...
  ggsave("plot_CorrelationRankAndBreakdown.tiff", width=15, height=6, dpi=500)
```
