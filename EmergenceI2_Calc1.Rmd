...
#normality test
shapiro.test(df_emerg_perc$FinalPop)


#data transformation
file <- df_emerg_perc

file$transf_sqr <- sqrt(df_emerg_perc$FinalPop)
file$transf_log <- log(df_emerg_perc$FinalPop)
file$transf_log1 <- log(df_emerg_perc$FinalPop+1)
file$transf_no <- 1*(df_emerg_perc$FinalPop)
head(file)
