...
-get dataframe combined with Iversen and Pok RAte  Emergence and mean soil Temp for Leura only between 5 and 15.66 degrees 
- optimum mean Temp for Leura is 15.66  
...
Subset cultivars Leura between temperature 5 to max 15.66 
...
df_L1 <-df_L %>%
  subset (meanTemp_Em>5 & meanTemp_Em<15.66)
