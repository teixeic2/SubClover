...
-get dataframe combined with Iversen and Pok RAte  Emergence and mean soil Temp for Narrikup only between 5 and 15.60 degrees 
- optimum mean Temp for Narrikup is 15.60  
...
Subset cultivars Narrikup between temperature 5 to max 15.6 
...
df_N1 <-df_N %>%
  subset (meanTemp_Em>5 & meanTemp_Em<15.6)
