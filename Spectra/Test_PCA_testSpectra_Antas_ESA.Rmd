...
fviz_pca_ind(res.pca, label="none", habillage=df_spA$IncubationDays)


# Add ellipses
p <- fviz_pca_ind(res.pca, label="none", habillage=df_spA$IncubationDays,
             addEllipses=TRUE, ellipse.level=0.95, alpha=0.9)
print(p)
```
