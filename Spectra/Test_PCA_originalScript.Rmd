...
ncol(decathlon2.active)
head(decathlon2.active[, 1:6])

str(decathlon2.active)

row.names(decathlon2.active)

# here:
df<-data.frame(x=c(1,2,3,4,5,6,7,8),y=c(4,5,6,7,8,9,0,23),z=c(14,25,36,47,38,49,40,23))
row.names(df) <-c("q","m","b","s","e","r","t","y")
```
