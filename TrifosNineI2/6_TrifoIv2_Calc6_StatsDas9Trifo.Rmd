...
- Calculate stat for the days to reach 9 trifoliates 
- Run ANOVA for variable "Number of days to reach 9 Trifoliates " 
...
getwd()
#create file
df_trifo <- read.table("df_DAS_9_Trifo.txt",header=TRUE)
head(df_trifo)
...
my.anova <- aov(DAS9T ~ SowTreat + Block, data = file.subs)
...
head(file.subset, 50)
   summary(file.subset)
my.anova <- aov(DAS9T ~ Cultivar + Block, data = file.subset)
