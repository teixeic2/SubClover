...
df_emerg1$transf_sqr <- sqrt(df_emerg1$DAS50E)
df_emerg1$transf_log <- log(df_emerg1$DAS50E)
df_emerg1$transf_ <- ln(df_emerg1$DAS50E+1)
df_emerg1$transf_no <- 1*(df_emerg1$DAS50E)
head(df_emerg1)

file <- df_emerg1

x <- c("transf_sqr", "transf_log", "transf_no", "transf_ln")
