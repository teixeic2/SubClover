...
graph the data of one plot to add in material and methods (compare with gompertz ). use Narrikup at 10 oC as example 
...
#  geom_point(data=sd_df,aes(x=DAS,y=NumberRun_mean)) +
  ...
  ylim(0,20 ) +
  #labs(y="Days 50% germination",x="Temperature")+
