...
theme(axis.text.y = element_text( size = 24))+ theme(axis.title.y = element_text(face="bold", size=24))+
...
#  # geom_abline(intercept = 50, slope = 0)
 ...
 ggsave("plot_spectraESA2018_Poster.png", width=12, height=8, dpi=400)
