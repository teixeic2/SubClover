...
## Normalization with Max Peak method 
...
Now combine the two dataframes (df_sp33 and df_43)and bring the file to build the graph
...
#  # geom_abline(intercept = 50, slope = 0)
 ...
 ggsave("plot_spectraMaxNorm_ESA2018_Poster.png", width=24, height=8, dpi=400)
