...
-get dataframe from Iversen Emergence and mean soil Temp for Denamrk between 5 and 14.6 degrees 
...
Subset cultivars Denmark between temperature 5 to max 14.6 
...
df_D1 <-df_D %>%
  subset (meanTemp_Em>5 & meanTemp_Em<24.6)
...
##confint(lm(y ~ x, df))
confint(lm(InvDAS50E ~ meanTemp_Em, df_D2))
...
summary(lm(InvDAS50E ~ meanTemp_Em, df_D2))
...
here get the equations for the Denamrk subset (min to optimum)  
...
Tb for Denmark is intercept / slope (x) = -0.0137 / 0.132 ~ 1.0 (0.03).
