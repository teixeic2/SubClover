...
df_emerg_perc3 <- df_emerg%>%
  dplyr::select(SowTreat,Cultivar,Block,Plot,DAS50E,TT50E)
...
head(file.subset, 50)
summary(file.subset)
my.anova <- aov(DAS50E ~ SowTreat*Cultivar + Block, 
                data = file.subset)
...
#(LSD.test(my.anova, c("SowTreat","SowTreat","Block"), alpha= 0.05, p.adj="none") )
