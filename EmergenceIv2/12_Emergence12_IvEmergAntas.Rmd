---
title: "Emergence seedlings I2  with Mean Soil Temp extended range "
author: "CT"
date: "17.08.2017"
output: 
...
df_A1 <-df_A %>%
  subset (meanTemp_Em>5 & meanTemp_Em<25.2)


#remove SowingDate 1 and 8  from both locations 
df_A2 <- df_A1 %>%
  filter (SowTreat=="S2"| SowTreat=="S6"|SowTreat=="S7"|SowTreat=="S8")
...
summary(lm(InvDAS50E ~ meanTemp_Em, df_A2))
...
##confint(lm(y ~ x, df))
confint(lm(InvDAS50E ~ meanTemp_Em, df_A2))
