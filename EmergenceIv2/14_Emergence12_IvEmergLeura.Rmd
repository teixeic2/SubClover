...
summary(lm(InvDAS50E ~ meanTemp_Em, df_L2))
...
##confint(lm(y ~ x, df))
confint(lm(InvDAS50E ~ meanTemp_Em, df_L2))

```



here get the equations for the Leura  subset (min to optimum)  
...
Tb for Leura is - intercept / slope x = -0.00178/0.01377 = -0.129 (?0.045)
