...
For Leura  : 
```{r}
#Create Thermal time cardinal temperatures see data above- TT = Topt - Tb ... 20 - (-0.13)= 21.3 ! 

#For cardinal temperatures 
#tt_card <- data.frame(temp=c(3.8,15,22,35),TT=c(0,15,15,0))
#for Tb=0
...
```{r}
df_TT <- df_merge%>%
   filter(SowTreat!= "S1"|SowTreat!= "S3"|SowTreat!= "S4"|SowTreat!= "S5")
