...
-get dataframe from Iversen Emergence and mean soil Temp for Monti between 5 and 15.0 degrees 
...
Subset cultivars Monti between temperature 5 to max 15 
...
df_M2 <- df_M1 %>%
   subset (SowTreat!="S1"| SowTreat!="S4")
...
summary(lm(InvDAS50E ~ meanTemp_Em, df_M2))
...
##confint(lm(y ~ x, df))
confint(lm(InvDAS50E ~ meanTemp_Em, df_M2))
...
Tb for Monti is - intercept / slope x = -0.026756/0.015915 = -1.73 (?0.05)
