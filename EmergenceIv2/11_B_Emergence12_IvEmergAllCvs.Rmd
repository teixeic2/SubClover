...
-get dataframe from Iversen Emergence and mean soil Temp for all cultivars only between 5 and 16.0 degrees 
- optimum mean Temp for all cvs  is 15.0  
- Find mean Tb and confidential intervals for Tb 
...
df_A1 <-df_G %>%
  subset (meanTemp_Em>5 & meanTemp_Em<15.0)
...
#print conf.intLow ; conf.intHigh
confint(mod)
