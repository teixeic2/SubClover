...
#tt_card <- data.frame(temp=c(0.4,15,22,35),TT=c(0,15,15,0))
#for Tb=0
...
get the TT and SE for all cultivars. For antas exclude S1, S3, S4, S5 . Consider Tb=0 for all cultivars. 
