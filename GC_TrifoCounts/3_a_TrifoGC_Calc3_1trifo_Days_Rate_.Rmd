...
- Calculate the time to reach selected  number of leaves : here first  Trifoliate 
...
df_emerg_perc3 <- df_DAE %>%
  dplyr::select(Cultivar,Block,Pot,DAE_1T)
...
file <- df_emerg_perc3
file$transf_no <- 1*(df_emerg_perc3$DAE_1T)
head(file)
