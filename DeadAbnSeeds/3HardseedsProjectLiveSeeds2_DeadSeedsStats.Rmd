...
##data transformation
file$transf_sqr <- sqrt(file$dead_perc)
file$transf_log <- log(file$dead_perc)
file$transf_not <- 1*(file$dead_perc/1)
file$transf_acos <- acos(file$dead_perc/100)
file$transf_sqrx <- (file$dead_perc^2)
