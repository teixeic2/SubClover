...
df_weather_selec <- df_weather %>%
  filter(LocationYear=="Katanning1990"|
           LocationYear=="Condobolin1986"|
           LocationYear=="Launceston1987"|
           LocationYear=="Melbourne1969") 
  

write.table(df_weather_selec, "df_weather_selec.txt")

write.table(df_test_select, "df_test_select.txt")

Data <- merge(df_test_select, df_weather_selec, by.x="TTtarg", by.y="SumTTday", all=TRUE)
y1.na <- is.na(Data$y1)
