...
# splitting and df due bug in tidyr (https://github.com/hadley/tidyr/issues/32)
  ...
  dfB %>%
    ungroup()%>%
    mutate (SowTreat= factor(SowTreat, levels=c("S1", "S2", "S3", "S4", "S6", "S7"),labels=c("June", "July", "Sept.", "Nov.", "Feb.","March")))%>%
...
axis.line = element_line(colour = "black"))+
   ...
   #margin y axis
   theme (axis.title.y = element_text( margin = margin(t=0,r=20,b=10,l=0)))+
...
theme(axis.text.x=element_text(angle = +0, hjust = 0.5,vjust=0.2 ,size=24))+
  theme(axis.text.y=element_text(angle = 0, hjust=0.5,vjust=0.2,size = 20)) 



   ggsave("plot_SeedYield_Prjct1_Iversen2.tiff", width=16, height=6, dpi=500)
