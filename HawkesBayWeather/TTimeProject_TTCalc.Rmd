---
title: "Thermal Time Calculation H Bat-Hastings Weather data"
author: "CT"
date: "01 Jan 2016"
output: 
...
C:\GitHubRepos\SubcloverPhD\SubClover\HawkesBayWeather

```{r readData}
setwd("C:\\GitHubRepos\\SubCloverPhD\\SubClover\\HawkesBayWeather")
getwd()

#create file
df_Weiv <- read.table("HawkesBayHistoricalWeather.txt", header=TRUE)
...
write.table(df_CumTTiv, "df_CumTT_HBay_Hastings.txt")
