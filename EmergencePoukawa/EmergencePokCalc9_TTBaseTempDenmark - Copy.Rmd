...
---
title: "ThermalTime calculation for Denmark with base temperature zero and TB emergence"
author: "CT"
...
- merge the two dataframes to calculate the thermal time for Denmark using the emergence Tb and assumed cardinal temps. 
...
```{r}
df1 <- merge(D,df_DenmarkTT, by.x="SowingDate",by.y="Date") %>%
