...
```{r loadFile}
# Get dataframe with info and DAS50E 
...
df_emerg4$Date <- ymd(df_emerg4$Date )
df_emerg4$SowingDate <- ymd(df_emerg4$SowingDate )
df_emerg4$Date50E <- ymd(df_emerg4$Date50E) 
...
Read the soil data (and adjust formats : need to add data Pouk
