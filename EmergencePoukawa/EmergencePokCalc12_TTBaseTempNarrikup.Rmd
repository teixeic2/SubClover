...
---
title: "ThermalTime calculation for Narrikup with base temperature zero and TB emergence"
author: "CT"
...
- merge the two dataframes to calculate the thermal time for Narrikup using the emergence Tb and assumed cardinal temps. 
...
```{r}
df1 <- merge(D,df_NarrikupTT, by.x="SowingDate",by.y="Date") %>%
