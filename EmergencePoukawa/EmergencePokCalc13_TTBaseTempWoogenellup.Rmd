---
title: "ThermalTime calculation for Woogenellup with base temperature zero and TB emergence"
author: "CT"
...
- merge the two dataframes to calculate the thermal time for Woogenellup using the emergence Tb and assumed cardinal temps. 
...
tt_card <- data.frame(temp=c(2.2,15,22,35),TT=c(0,15,15,0))
...
```{r}
df1 <- merge(D,df_WoogenellupTT, by.x="SowingDate",by.y="Date") %>%
