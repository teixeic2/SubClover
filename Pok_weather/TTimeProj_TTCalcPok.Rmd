---
title: "Thermal Time Calculation Poukawa Weather data"
author: "CT"
date: "28.03.2017"
...
#create file this is already updated with station 40256 Marakakeho
...
df_WePo %>%
  ...
  ylab(expression(Temperature~time~~"("^"o"*"C)/hours"))+
  theme(axis.text.y = element_text(size=18))+
  theme(axis.title.y = element_text(size=22))+
  theme(legend.text = element_text(size=22))+
  theme(axis.title.x = element_text(size=22))+
  theme(axis.text.x = element_text(angle = 0, hjust = 1, size=22))  
...
write.table(df_CumTTPo, "df_CumTTPo.txt")
