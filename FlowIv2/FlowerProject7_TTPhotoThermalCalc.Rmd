...
note: include Pp analysis using selected datasets from Reanalysis scripts but use
  Iversen 2 collected data; this script is a continuation of script 6 and calculates the equations from Weir et al 1984.
...
```{r, fig.height=10, fig.width= 12}
 ...
 dfGraph1 <- df_FP%>% 
  ...
  select(Cultivar,SowingD,SowTreat, Photo ,  TT50F, Pp_target)%>%
