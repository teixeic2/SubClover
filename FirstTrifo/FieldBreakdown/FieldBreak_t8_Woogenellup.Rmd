...
---
Purpose : 
This script reads the data from the field seed hardness breakdown generated in script 2  (buried mesh bags for Woogenellup )
...
Adjust y axis to 50 for Woogenellup 
```{r}
df_W1 %>%
dplyr::select(Cultivar, Block, x,y)%>%
ggplot(aes(x=x, y=y)) +
