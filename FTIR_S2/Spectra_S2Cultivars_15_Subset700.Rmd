...
#In this script the analysis of wavenumber range 800 and 650 is performed. find peaks in this region   
---
...
df_700<-file1 %>%
  #subset range 
  subset (wavelength<700 & wavelength>600)
...
```
take apart the  peak 710 (crystalline  cellullose according to Abidi et al 2014 ) subset data for this peak   

```{r}

df_710 <-file1 %>%
  #subset peak
  subset (wavelength==710)
