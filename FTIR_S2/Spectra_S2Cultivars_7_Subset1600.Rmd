...
#In this script the analysis of wavenumber range 1600 and 1650 is performed. find peak in this region   
---
...
df_1600<-file1 %>%
  ...
  subset (wavelength<1650 & wavelength>1600)
...
```
identified peak 1610. subset data for this peak   

```{r}

df_1610 <-file1 %>%
  #subset peak
  subset (wavelength==1610)
...
End of this script. continue with another peak in script 8.
