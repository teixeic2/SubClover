...
#In this script the analysis of wavenumber range 1860 and 1875 is performed. find peaks in this region   
---
...
df_1870<-file1 %>%
  #subset range 
  subset (wavelength<1880 & wavelength>1866)
...
```
take apart the  peak 669  subset data for this peak   

```{r}

df_1871 <-file1 %>%
  #subset peak
  subset (wavelength==1871)
