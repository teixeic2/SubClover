...
#In this script the analysis of wavenumber range 1400 and 1300 is performed. find peaks in this region   
---
...
df_1300<-file1 %>%
  #subset range 
  subset (wavelength<1300 & wavelength>1200)
...
```
identified peak 1378 (as per Dong et al 2007) subset data for this peak   

```{r}

df_1377 <-file1 %>%
  #subset peak
  subset (wavelength==1377)
...
End of this script. continue with another peak in script 11.
