...
#In this script the analysis of wavenumber range 1350 and 1250 is performed. find peaks in this region   
---
...
df_1350<-file1 %>%
  #subset range 
  subset (wavelength<1350 & wavelength>1250)
...
```
take apart the  peak 1338 (cellulose! ) subset data for this peak   

```{r}

df_1338 <-file1 %>%
  #subset peak
  subset (wavelength==1338)
...
End of this script. continue with another peak in script 12.
